...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"易找车","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 33 */
/*!***********************************************!*\
  !*** D:/EasyCar/易找车/uni.promisify.adaptor.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  onShareAppMessage: function onShareAppMessage(res) {
    ...
    var route = curPage[curPage.length - 1].route; //获取当前页面的路由
    var params = curPage[curPage.length - 1].options; //获取当前页面参数，如果有则返回参数的对象，没有参数返回空对象{}
    var query = '';
    var keys = Object.keys(params); //获取对象的key 返回对象key的数组
    if (keys.length > 0) {
      query = keys.reduce(function (pre, cur) {
...
var BASE_URL = 'http://www.myeasycar.cn/api'; // 后端服务基础地址
...
function _refreshToken() {
  _refreshToken = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var refreshToken;
                ...
                success: function success(res) {
                  if (res.statusCode === 200 && res.data.code === 200) {
                    var _res$data$data = res.data.data,
                      accessToken = _res$data$data.accessToken,
                      newRefreshToken = _res$data$data.refreshToken;
 ...
 */
function _request() {
  _request = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(url) {
    var options,
      accessToken,
      res,
      newAccessToken,
 ...
 * @returns {Promise} - 返回Promise对象
 */
function addParking(photo, parkingLocation, location) {
  return post('/add', {
    photo: photo,
